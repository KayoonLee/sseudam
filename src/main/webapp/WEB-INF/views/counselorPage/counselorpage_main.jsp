...
<%@ include file="../navigator_footer/counselor_sidebar.jsp" %>
    <main id="main" class="main">
        <div class="pagetitle">
            ...
            <nav>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="main_page.html">Home</a></li>
                            ...
                            <div class="tab-content pt-2">
                                ...
                                <div class="tab-pane fade show active profile-overview" id="profile-overview">
                                   ...
                                   <div class="card">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-3 col-md-4 label">경력사항</div>
                                        <div class="col-lg-9 col-md-8">${counsel.career}</div>
                                    </div>

                                    <div class="row">
                                        <div class="col-lg-3 col-md-4 label">자격증</div>
                                        <div class="col-lg-9 col-md-8">${counsel.license}</div>
                                    </div>
