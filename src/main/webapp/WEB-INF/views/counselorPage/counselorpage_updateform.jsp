              ...
              <div class="tab-content pt-2">
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-md-8 col-lg-9">
                    ...
                    <div class="pt-2">
                      <input type="file" id="memberProfile" name="files"
                             onchange="previewImage(this)">
                      <%-- 이미지 업로드 하기 --%>
                      <button type="button" onclick="upProfile()" class="btn btn-primary btn-sm"
                              title="Upload new profile image"><i class="bi bi-upload"></i>
                      </button>
                      <%-- 이미지 삭제 하기 --%>
                      <button type="button" onclick="delProfile()" class="btn btn-danger btn-sm"
                    ...
                    <div class="row mb-3">
                       <label for="Address" class="col-md-4 col-lg-3 col-form-label">경력사항</label>
                           <div class="col-md-8 col-lg-9">
                           <input name="career" type="text" class="form-control" id="career" value="${counsel.career}">
                           </div>
                    </div>
                    <div class="row mb-3">
                       <label for="Address" class="col-md-4 col-lg-3 col-form-label">자격증</label>
                           <div class="col-md-8 col-lg-9">
                           <input name="license" type="text" class="form-control" id="license" value="${counsel.license}">
                           </div>
                    </div>
