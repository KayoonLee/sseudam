...
<head>
    ...
    <title>jQuery Datetime Picker Plugin Examples</title>
    <style>
        html, * {
            font-family: 'Inter';
...
<div class="container">
    <h1>jQuery datetimepicker Plugin Examples</h1>
    ...
    <p style="margin:2rem auto"><a class="download"
                                   href="https://www.jqueryscript.net/time-clock/Clean-jQuery-Date-Time-Picker-Plugin-datetimepicker.html">Download
        This Plugin</a> <a class="download" href="https://www.jqueryscript.net/">Back To jQueryScript</a></p>
    <p class="lead">A jQuery plugin that popups a simple and clean date & time picker interface when an input field on
        focus.</p>
    ...
    <input type="text" id="datetimepicker4"/><input id="open" type="button" value="open"/><input id="close"
                                                                                                 type="button"
                                                                                                 value="close"/>
