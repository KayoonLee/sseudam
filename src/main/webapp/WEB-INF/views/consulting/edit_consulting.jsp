    ...
    <form method="POST">
      ...
      <div class="row mb-3">
        ...
        <div class="col-sm-10">
          ...
          <input type="hidden" name="m_id" value="${gen.m_id}">
        </div>
      </div>
      <div class="row mb-3">
      ...
      <div class="row mb-3">
        ...
        <div class="col-sm-10">
          <input type="text" class="form-control" id ="subject" name = "subject" value="${counselrecord.subject}" maxlength="50" >
        </div>
      </div>
      <%--
                  <div class="row mb-3">
      ...
      <div class="row mb-3">
        ...
        <div class="col-sm-10">
          <textarea class="form-control" style="height: 100px" id="content" name="content" maxlength="2000" >${counselrecord.content}</textarea>
        </div>
      </div>
      <%--
      ...
      <div class="row mb-3">
        ...
        <div class="col-sm-10">
          <textarea class="form-control" style="height: 100px" id="etc" name="etc" maxlength="50">${counselrecord.etc}</textarea>
        </div>
      </div>
      <div class="row mb-3">
        <label class="col-sm-2 col-form-label"></label>
        <div class="col-sm-10">
          <input type="submit" class="btn btn-primary" value="기록 수정" onclick="javascript: form.action='update_Consulting';">
        </div>
      </div>
