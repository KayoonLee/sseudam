...
<div>
	...
	<div>
		...
		<div class="btn-group">
			<button type="button" class="btn btn-outline-success" onClick="location.href='freeList?num=${num}&category=${category}'">최신순</button>
			<button type="button" class="btn btn-outline-success" onClick=
					"location.href='freeList?num=${num}&category=${category}&sort=readcount'">조회순</button>
			<button type="button" class="btn btn-outline-success" onClick=
					"location.href='freeList?num=${num}&category=${category}&sort=recom'">추천순</button>
		</div>
	</div>
	<div>
		<ul>
