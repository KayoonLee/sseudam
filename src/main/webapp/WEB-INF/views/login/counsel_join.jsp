        ...
        <form class="validation-form" action="insertCounsel" method="post">
         <input type="hidden" name="identifier" value="3"><!--상담사 승인대기: 3, 상담사: 2-->
          ...
          <div class="mb-3">
           ...
           <div class="mb-3">
              <label for="tel">경력사항 (선택)</label>
              <input type="text" class="form-control" id="career" name="career" placeholder="선택사항"
           </div>

            <div class="mb-3">
              <label for="tel">자격증 (선택)</label>
              <input type="text" class="form-control" id="license" name="license" placeholder="선택사항">
            </div>
