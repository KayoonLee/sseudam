...
<html>
<head>
    <title>관리자/일반회원/상담사222233334445555556666667777777777888899100000000111111brTobr</title>
    <meta charset="UTF-8">
    ...
    <div class="w3-modal-content w3-animate-zoom">
        ...
        <div class="w3-container">
            ...
            <form action="/action_page.php" target="_blank">
                ...
                <p><input class="w3-input w3-padding-16 w3-border" type="number" placeholder="How many animal" required name="People"></p>
                <p><input class="w3-input w3-padding-16 w3-border" type="datetime-local" placeholder="Date and time" required name="date" value="2020-11-16T20:00"></p>
                <p><input class="w3-input w3-padding-16 w3-border" type="text" placeholder="Message \ Special requirements" required name="Message"></p>
                <p><button class="w3-button" type="submit">메시지 전송</button></p>
            </form>
        </div>
    </div>
</div>
